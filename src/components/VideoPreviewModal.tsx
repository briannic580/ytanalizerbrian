...
import { IconX, IconBookmark, IconCopy, IconDownload } from '../constants/icons';
...
const VideoPreviewModal: React.FC<VideoPreviewModalProps> = ({
  ...
  }, [isOpen, onClose, onNext, onPrev, hasNext, hasPrev, video, onSaveToggle]);
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-3 mt-6 pt-6 border-t border-border">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={copyLink}
                  className="flex-1 flex items-center justify-center gap-2 py-3 bg-secondary text-foreground rounded-2xl font-bold text-sm hover:bg-accent transition-colors"
                >
                ...
                <motion.button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-3 bg-primary/10 text-primary rounded-2xl font-bold text-sm hover:bg-primary/20 transition-colors"
                >
